...
if __name__ == "__main__":
    url = "https://youtube.com/playlist?list=PLsZsFDd78QmnhZE_j7tPsw9iy8aiknTRy"
    ...
    while soup.find_all('a', id='thumbnail') == 0:
        soup = bs.BeautifulSoup(page.html, 'html.parser')
    ...
    for link in new_links:
        ...
        out_file = stream.download(output_path="YOUR PATH HERE") # PUT YOUR FOLDER IN THE QUOTES
        try:
            base, ext = os.path.splitext(out_file)
            new_file = base + '.mp3'
            os.rename(out_file, new_file)
        except:
            print("file already exists probably :)")
